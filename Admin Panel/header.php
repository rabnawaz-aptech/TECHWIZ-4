        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <div data-i18n="Layouts">Add Products</div>
            </a>
          ...
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <div data-i18n="Account Settings">Products Settings</div>
            </a>
            <ul class="menu-sub">
              <li class="menu-item">
              ...
              <li class="menu-item">
                <a href="allproduct.php" class="menu-link">
          ...
          <li class="menu-item">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
              ...
              <div data-i18n="User interface">Users Settings</div>
            </a>
            <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
              ...
              <div data-i18n="Extended UI">Orders Settitngs</div>
            </a>
            <ul class="menu-sub">
              <li class="menu-item">
