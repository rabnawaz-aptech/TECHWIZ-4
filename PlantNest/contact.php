...
$m = $_POST['message'];
 ...
 $q1 ="INSERT INTO `contact`(`user name`,`email`,`subject`,`message`) VALUES ('$n','$e','$s','$m')";
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <form method="POST">
                                        <input type="text" name="fullname" class="form-control" id="contact-name" placeholder="Your Name">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
